...
<body>
    ...
    <header class="header" id="mainHeader">
        <nav class="header-nav">
            <a href="<?php echo e(url('/')); ?>" class="active">Properties</a>
            <a href="<?php echo e(route('register')); ?>">List Your Property</a>
            <a href="#">About</a>
        </nav>
        <div class="header-actions">
            ...
            <?php else: ?>
                <div class="user-menu">
                    <div class="user-avatar"><?php echo e(strtoupper(substr(Auth::user()->first_name ?? 'U', 0, 1) . substr(Auth::user()->last_name ?? 'S', 0, 1))); ?></div>
                    <a href="<?php echo e(route('home')); ?>" class="btn btn-ghost">My Dashboard</a>
    ...
    <!-- Hero Section -->
    <section class="hero">
        <img src="<?php echo e(asset('images/hero-bg.jpg')); ?>" alt="" class="hero-bg">
        ...
        <div class="hero-content">
            ...
            <!-- Search Card -->
            <form action="<?php echo e(url('/search')); ?>" method="GET" class="search-card" id="searchForm">
        ...
        <div class="container">
            ...
            <div class="section-header">
                <div>
                    ...
                    <p class="section-count"><?php echo e($propertyCount); ?> properties available</p>
                </div>
            ...
            <div class="properties-grid">
                ...
                <a href="<?php echo e(url('/property/'.$property['id'])); ?>" class="property-card">
                    <div class="property-card-image">
                        <img src="<?php echo e($property['image']); ?>" alt="<?php echo e($property['title']); ?>">
                        <div class="property-card-badge"><?php echo e(currency_symbol($property['currency'])); ?><?php echo e($property['price']); ?>/night</div>
                    ...
                    <div class="property-card-content">
                        <div class="property-card-type"><?php echo e($property['type']); ?></div>
                        <h3 class="property-card-title"><?php echo e($property['title']); ?></h3>
                        ...
                        <div class="property-card-features">
                            <span class="property-card-feature">
                                ...
                                <?php echo e($property['guests']); ?> guests
                            </span>
                            <span class="property-card-feature">
                            ...
                            <span class="property-card-feature">
                                ...
                                <?php echo e($property['baths']); ?> baths
                            </span>
                        </div>
                    </div>
                </a>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    <img src="<?php echo e(asset('images/tref-logo.png')); ?>" alt="Tref Stays" class="footer-logo">
            ...
            <div class="footer-bottom">
                <p>© <?php echo e(date('Y')); ?> Tref. All rights reserved.</p>
    ...
    <script>
        ...
        function handleCountrySelectChange(select) {
            if (select.value === 'map') {
                window.location.href = '<?php echo e(url('/search')); ?>?view=map';
            }
        }
...
<?php /**PATH D:\Tref Website\Testing\ya last ha final ala - Copy\ivr\ivr-reservation-system-master\resources\views/tref/welcome.blade.php ENDPATH**/ ?>