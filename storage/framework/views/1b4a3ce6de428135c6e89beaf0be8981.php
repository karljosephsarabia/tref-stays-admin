...
<body>
    <div class="auth-card" id="authCard">
        <div class="auth-header">
            <a href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('images/tref-logo.png')); ?>" alt="Tref Stays" class="auth-logo">
            </a>
        ...
        <div class="auth-content">
            ...
            <div id="stepRenter" class="hidden">
                <form method="POST" action="<?php echo e(route('register')); ?>" id="renterForm">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="role_id" value="renter">
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">First Name</label>
                            <input type="text" name="first_name" class="form-input <?php echo e($errors->has('first_name') ? 'error' : ''); ?>" placeholder="John" required data-validate="required" value="<?php echo e(old('first_name')); ?>">
                            <div class="error-text" id="error-first_name" style="<?php echo e($errors->has('first_name') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('first_name')); ?></div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Last Name</label>
                            <input type="text" name="last_name" class="form-input <?php echo e($errors->has('last_name') ? 'error' : ''); ?>" placeholder="Doe" required data-validate="required" value="<?php echo e(old('last_name')); ?>">
                            <div class="error-text" id="error-last_name" style="<?php echo e($errors->has('last_name') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('last_name')); ?></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" class="form-input <?php echo e($errors->has('email') ? 'error' : ''); ?>" placeholder="your@email.com" required data-validate="email" value="<?php echo e(old('email')); ?>">
                        <div class="error-text" id="error-email" style="<?php echo e($errors->has('email') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('email')); ?></div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Phone Number</label>
                        <input type="tel" name="phone_number" class="form-input <?php echo e($errors->has('phone_number') ? 'error' : ''); ?>" placeholder="+1 (555) 000-0000" required data-validate="phone" value="<?php echo e(old('phone_number')); ?>">
                        <div class="error-text" id="error-phone_number" style="<?php echo e($errors->has('phone_number') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('phone_number')); ?></div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">PIN (4-6 digits)</label>
                        <input type="text" name="pin" class="form-input <?php echo e($errors->has('pin') ? 'error' : ''); ?>" placeholder="1234" required data-validate="pin" maxlength="6" value="<?php echo e(old('pin')); ?>">
                        <div class="error-text" id="error-pin" style="<?php echo e($errors->has('pin') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('pin')); ?></div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Password</label>
                        <input type="password" name="password" class="form-input <?php echo e($errors->has('password') ? 'error' : ''); ?>" placeholder="••••••••" required data-validate="password">
                        <div class="error-text" id="error-password" style="<?php echo e($errors->has('password') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('password')); ?></div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Confirm Password</label>
                        <input type="password" name="password_confirmation" class="form-input <?php echo e($errors->has('password_confirmation') ? 'error' : ''); ?>" placeholder="••••••••" required data-validate="confirm_password">
                        <div class="error-text" id="error-password_confirmation" style="<?php echo e($errors->has('password_confirmation') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('password_confirmation')); ?></div>
                    </div>
                    <?php if($errors->has('role_id')): ?>
                    <div class="error-text" style="display:block;margin-bottom:1rem;"><?php echo e($errors->first('role_id')); ?></div>
                    <?php endif; ?>
                    <div class="btn-row">
            ...
            <!-- Owner Wizard Steps -->
            <form id="ownerForm" method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data" class="hidden">
                <?php echo csrf_field(); ?>
                ...
                <div id="ownerStep1">
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">First Name</label>
                            <input type="text" name="first_name" class="form-input <?php echo e($errors->has('first_name') ? 'error' : ''); ?>" placeholder="John" required data-validate="required" value="<?php echo e(old('first_name')); ?>">
                            <div class="error-text" id="error-owner-first_name" style="<?php echo e($errors->has('first_name') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('first_name')); ?></div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Last Name</label>
                            <input type="text" name="last_name" class="form-input <?php echo e($errors->has('last_name') ? 'error' : ''); ?>" placeholder="Doe" required data-validate="required" value="<?php echo e(old('last_name')); ?>">
                            <div class="error-text" id="error-owner-last_name" style="<?php echo e($errors->has('last_name') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('last_name')); ?></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" class="form-input <?php echo e($errors->has('email') ? 'error' : ''); ?>" placeholder="your@email.com" required data-validate="email" value="<?php echo e(old('email')); ?>">
                        <div class="error-text" id="error-owner-email" style="<?php echo e($errors->has('email') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('email')); ?></div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Phone Number</label>
                        <input type="tel" name="phone_number" class="form-input <?php echo e($errors->has('phone_number') ? 'error' : ''); ?>" placeholder="+1 (555) 000-0000" required data-validate="phone" value="<?php echo e(old('phone_number')); ?>">
                        <div class="error-text" id="error-owner-phone_number" style="<?php echo e($errors->has('phone_number') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('phone_number')); ?></div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">PIN (4-6 digits)</label>
                        <input type="text" name="pin" class="form-input <?php echo e($errors->has('pin') ? 'error' : ''); ?>" placeholder="1234" required data-validate="pin" maxlength="6" value="<?php echo e(old('pin')); ?>">
                        <div class="error-text" id="error-owner-pin" style="<?php echo e($errors->has('pin') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('pin')); ?></div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Password</label>
                        <input type="password" name="password" class="form-input <?php echo e($errors->has('password') ? 'error' : ''); ?>" placeholder="••••••••" required data-validate="password">
                        <div class="error-text" id="error-owner-password" style="<?php echo e($errors->has('password') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('password')); ?></div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Confirm Password</label>
                        <input type="password" name="password_confirmation" class="form-input <?php echo e($errors->has('password_confirmation') ? 'error' : ''); ?>" placeholder="••••••••" required data-validate="confirm_password">
                        <div class="error-text" id="error-owner-password_confirmation" style="<?php echo e($errors->has('password_confirmation') ? 'display:block;' : ''); ?>"><?php echo e($errors->first('password_confirmation')); ?></div>
                    </div>
                </div>
                ...
                <div id="ownerStep5" class="hidden">
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox-group">
                            <?php $__currentLoopData = ['WiFi', 'Air Conditioning', 'Heating', 'Kitchen', 'Washer', 'Dryer', 'Free Parking', 'Pool', 'Hot Tub', 'Gym', 'TV', 'Workspace']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if($errors->any() && old('role_id')): ?>
                <?php if(old('role_id') == '2'): ?>
                    // Renter form
                    document.getElementById('step0').classList.add('hidden');
                    document.getElementById('stepRenter').classList.remove('hidden');
...
<?php /**PATH D:\Tref Website\Testing\ya last ha final ala - Copy\ivr\ivr-reservation-system-master\resources\views/tref/register.blade.php ENDPATH**/ ?>