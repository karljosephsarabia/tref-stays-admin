...
<div class="card" style="margin-bottom: 24px;">
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('admin.properties')); ?>" class="filters">
            <div class="filter-group">
                <input type="text" name="search" class="form-control" placeholder="Search properties..." value="<?php echo e(request('search')); ?>" style="width: 250px;">
            </div>
            <div class="filter-group">
                <select name="owner_id" class="form-control">
                    ...
                    <?php $__currentLoopData = $owners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($owner->id); ?>" <?php echo e(request('owner_id') == $owner->id ? 'selected' : ''); ?>>
                            <?php echo e($owner->first_name); ?> <?php echo e($owner->last_name); ?>
            ...
            <a href="<?php echo e(route('admin.properties')); ?>" class="btn btn-secondary">
                <i class="fas fa-times"></i> Clear
            </a>
            <div style="margin-left: auto;">
                <a href="<?php echo e(route('admin.properties.new')); ?>" class="btn btn-primary">
...
<div class="stats-grid" style="margin-bottom: 24px;">
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($properties->total()); ?></div>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value"><?php echo e($properties->where('active', true)->count()); ?></div>
        </div>
    </div>
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value">$<?php echo e(number_format($properties->avg('price'), 0)); ?></div>
        </div>
    </div>
</div>
            ...
            <div class="property-card" style="background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08); transition: transform 0.2s, box-shadow 0.2s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 24px rgba(0,0,0,0.12)';" onmouseout="this.style.transform=''; this.style.boxShadow='0 2px 8px rgba(0,0,0,0.08)';">
                <div style="position: relative; height: 200px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <?php if($property->images->count() > 0): ?>
                        <img src="<?php echo e(property_image_url($property->images->first()->image_url)); ?>" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.onerror=null; this.src='<?php echo e(asset('/images/property-placeholder.svg')); ?>'">
                    <?php else: ?>
                    ...
                    <div style="position: absolute; top: 12px; right: 12px; display: flex; flex-direction: column; gap: 8px; align-items: flex-end;">
                        <span class="badge <?php echo e($property->active ? 'badge-success' : 'badge-danger'); ?>">
                            <?php echo e($property->active ? 'Active' : 'Inactive'); ?>

                        </span>
                        <?php if($property->show_on_homepage): ?>
                            <span class="badge" style="background: <?php echo e($property->highlight_color ?? '#FF385C'); ?>; color: #fff;">
                                Homepage
                                <?php if($property->homepage_order): ?>
                                    · #<?php echo e($property->homepage_order); ?>

                                <?php endif; ?>
                            </span>
                        <?php endif; ?>
                        <?php if($property->featured_badge): ?>
                            <span class="badge" style="background: rgba(255,255,255,0.9); color: <?php echo e($property->highlight_color ?? '#FF385C'); ?>; border: 1px solid <?php echo e($property->highlight_color ?? '#FF385C'); ?>;">
                                <?php echo e($property->featured_badge); ?>

                            </span>
                        <?php endif; ?>
                    </div>
                    <div style="position: absolute; bottom: 12px; left: 12px; background: white; padding: 6px 12px; border-radius: 8px; font-weight: 600;">
                        $<?php echo e(number_format($property->price)); ?>/night
                    </div>
                </div>
                <div style="padding: 16px;">
                    ...
                    <p style="font-size: 13px; color: var(--gray-500); margin-bottom: 12px;">
                        <i class="fas fa-map-marker-alt"></i> <?php echo e($property->map_address ?? 'No address'); ?>

                    </p>
                    <div style="display: flex; gap: 16px; font-size: 13px; color: var(--gray-500); margin-bottom: 16px;">
                        <span><i class="fas fa-user"></i> <?php echo e($property->guest_count); ?> guests</span>
                        <span><i class="fas fa-bed"></i> <?php echo e($property->bedroom_count); ?> beds</span>
                        <span><i class="fas fa-bath"></i> <?php echo e($property->bathroom_count); ?> baths</span>
                    </div>
                    <?php if($property->hero_title || $property->spotlight_message): ?>
                        <div style="background: <?php echo e(($property->highlight_color ?? '#FF385C')); ?>10; border: 1px solid <?php echo e(($property->highlight_color ?? '#FF385C')); ?>33; border-radius: 12px; padding: 12px 16px; margin-bottom: 16px;">
                            <?php if($property->hero_title): ?>
                                <div style="font-weight: 600; color: <?php echo e($property->highlight_color ?? '#FF385C'); ?>;"><?php echo e($property->hero_title); ?></div>
                                <div style="font-size: 13px; color: var(--gray-500);"><?php echo e($property->hero_subtitle); ?></div>
                            <?php endif; ?>
                            <?php if($property->spotlight_message): ?>
                                <p style="font-size: 13px; color: var(--gray-600); margin-top: 8px;"><?php echo e($property->spotlight_message); ?></p>
                            <?php endif; ?>
                            <?php if($property->hero_cta_text && $property->hero_cta_url): ?>
                                <a href="<?php echo e($property->hero_cta_url); ?>" target="_blank" style="display: inline-flex; align-items: center; gap: 6px; margin-top: 10px; font-size: 12px; text-transform: uppercase; font-weight: 600; color: <?php echo e($property->highlight_color ?? '#FF385C'); ?>;">
                                    <?php echo e($property->hero_cta_text); ?> <i class="fas fa-arrow-up-right-from-square"></i>
                                </a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                    <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--gray-200); padding-top: 12px;">
                        <div style="font-size: 13px; color: var(--gray-500);">
                            <i class="fas fa-user-circle"></i> <?php echo e($property->owner->first_name ?? 'N/A'); ?> <?php echo e($property->owner->last_name ?? ''); ?>

                        </div>
                        <div class="actions">
                            <button class="btn btn-secondary btn-icon btn-sm" onclick="editProperty(<?php echo e($property->id); ?>)" title="Edit">
                                    <i class="fas fa-edit"></i>
                            </button>
                            <button class="btn btn-secondary btn-icon btn-sm" onclick="toggleProperty(<?php echo e($property->id); ?>)" title="Toggle Status">
                                <i class="fas fa-power-off"></i>
                            </button>
                            <button class="btn btn-danger btn-icon btn-sm" onclick="deleteProperty(<?php echo e($property->id); ?>)" title="Delete">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($property->show_on_homepage): ?>
                                    <span class="badge" style="background: <?php echo e($property->highlight_color ?? '#FF385C'); ?>; color: #fff;">Homepage</span>
                                <?php endif; ?>
                                <?php if($property->featured_badge): ?>
                                    <span class="badge" style="border: 1px solid <?php echo e($property->highlight_color ?? '#FF385C'); ?>; color: <?php echo e($property->highlight_color ?? '#FF385C'); ?>; background: transparent;"><?php echo e($property->featured_badge); ?></span>
                                <?php endif; ?>
                                <?php if($property->allow_instant_booking): ?>
                                    <span class="badge badge-info">Instant</span>
                                <?php endif; ?>
                                <?php if($property->is_luxury_tier): ?>
                            ...
                            <td>
                                <div class="actions">
                                    <button class="btn btn-secondary btn-icon" onclick="toggleProperty(<?php echo e($property->id); ?>)">
                                        <i class="fas fa-power-off"></i>
                                    </button>
                                    <button class="btn btn-secondary btn-icon" onclick="editProperty(<?php echo e($property->id); ?>)">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button class="btn btn-danger btn-icon" onclick="deleteProperty(<?php echo e($property->id); ?>)">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                </div>
                            </td>
...
<div class="pagination">
    <?php echo e($properties->withQueryString()->links()); ?>
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <select name="owner_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $owners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($owner->id); ?>"><?php echo e($owner->first_name); ?> <?php echo e($owner->last_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
...
<script>
    const propertiesData = [
        <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        {
            ...
            owner_id: <?php echo e($property->owner_id ?? 'null'); ?>,
            price: <?php echo e($property->price ?? 0); ?>,
            guest_count: <?php echo e($property->guest_count ?? 1); ?>,
            bedroom_count: <?php echo e($property->bedroom_count ?? 1); ?>,
            bed_count: <?php echo e($property->bed_count ?? 1); ?>,
            bathroom_count: <?php echo e($property->bathroom_count ?? 1); ?>,
            map_address: <?php echo json_encode($property->map_address); ?>,
            additional_information: <?php echo json_encode($property->additional_information); ?>,
            show_on_homepage: <?php echo e($property->show_on_homepage ? 'true' : 'false'); ?>,
            homepage_order: <?php echo e($property->homepage_order ?? 'null'); ?>,
            featured_badge: <?php echo json_encode($property->featured_badge); ?>,
            highlight_color: <?php echo json_encode($property->highlight_color ?? '#FF385C'); ?>,
            hero_title: <?php echo json_encode($property->hero_title); ?>,
            hero_subtitle: <?php echo json_encode($property->hero_subtitle); ?>,
            hero_cta_text: <?php echo json_encode($property->hero_cta_text); ?>,
            hero_cta_url: <?php echo json_encode($property->hero_cta_url); ?>,
            banner_image_url: <?php echo json_encode($property->banner_image_url); ?>,
            spotlight_message: <?php echo json_encode($property->spotlight_message); ?>,
            display_layout: <?php echo json_encode($property->display_layout ?? 'gallery'); ?>,
            allow_instant_booking: <?php echo e($property->allow_instant_booking ? 'true' : 'false'); ?>,
            is_luxury_tier: <?php echo e($property->is_luxury_tier ? 'true' : 'false'); ?>,
            seo_title: <?php echo json_encode($property->seo_title); ?>,
            seo_description: <?php echo json_encode($property->seo_description); ?>,
            seo_keywords: <?php echo json_encode($property->seo_keywords); ?>,
            custom_css: <?php echo json_encode($property->custom_css); ?>,
            custom_js: <?php echo json_encode($property->custom_js); ?>
    ...
    async function submitCreateProperty(e) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.properties.create")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tref Website\Testing\ya last ha final ala - Copy\ivr\ivr-reservation-system-master\resources\views/admin/properties.blade.php ENDPATH**/ ?>