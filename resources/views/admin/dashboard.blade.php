...
<div class="card" style="background: linear-gradient(135deg, var(--primary) 0%, #e31c5f 100%); color: white; margin-bottom: 32px;">
    <div class="card-body" style="padding: 32px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h2 style="font-size: 24px; font-weight: 600; margin-bottom: 8px;">Welcome back, {{ Auth::user()->first_name ?? 'Admin' }}! 👋</h2>
...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <div class="quick-stats">
                <span class="quick-stat"><strong>{{ $activeUsers }}</strong> active</span>
            </div>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value">{{ number_format($totalProperties) }}</div>
            <div class="quick-stats">
                <span class="quick-stat"><strong>{{ $activeProperties }}</strong> active</span>
            </div>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <div class="quick-stats">
                <span class="quick-stat"><strong>{{ $pendingReservations }}</strong> pending</span>
            </div>
        </div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            @if($revenueGrowth != 0)
            <span class="stat-change {{ $revenueGrowth >= 0 ? 'positive' : 'negative' }}">
...
<div class="stats-grid" style="margin-bottom: 32px;">
    ...
    <div class="stat-card">
        ...
        <div class="stat-content">
            ...
            <div class="stat-value">{{ $totalBrokers }}</div>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-top: 24px;">
                <div style="display: flex; align-items: center; gap: 8px;">
                    ...
                    <span style="font-size: 13px;">Pending ({{ $pendingReservations }})</span>
                </div>
                <div style="display: flex; align-items: center; gap: 8px;">
                    <span style="width: 12px; height: 12px; border-radius: 3px; background: #10b981;"></span>
                    <span style="font-size: 13px;">Confirmed ({{ $confirmedReservations }})</span>
                </div>
                <div style="display: flex; align-items: center; gap: 8px;">
                    <span style="width: 12px; height: 12px; border-radius: 3px; background: #3b82f6;"></span>
                    <span style="font-size: 13px;">Completed ({{ $completedReservations }})</span>
                </div>
                <div style="display: flex; align-items: center; gap: 8px;">
                    <span style="width: 12px; height: 12px; border-radius: 3px; background: #ef4444;"></span>
                    <span style="font-size: 13px;">Cancelled ({{ $cancelledReservations }})</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="grid-2">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-{{ $user->role_id == 'admin' ? 'primary' : ($user->role_id == 'broker' ? 'info' : 'secondary') }}">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('admin.reservations') }}" class="btn btn-secondary btn-sm">View All</a>
        </div>
        <div class="card-body" style="padding: 0;">
            <div class="table-container">
                <table>
...
<div class="card" style="margin-top: 32px;">
    <div class="card-header">
        ...
        <a href="{{ route('admin.properties') }}" class="btn btn-secondary btn-sm">View All</a>
    </div>
    <div class="card-body" style="padding: 0;">
        <div class="table-container">
            <table>
...
<script>
    ...
    const statusData = @json($reservationsByStatus);
